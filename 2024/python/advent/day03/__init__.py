...
Only the four highlighted sections are real mul instructions. Adding up the result of each instruction produces 161 (2*4
+ 5*5 + 11*8 + 8*5).
...
__all__ = ["solve_part_one", "solve_part_two"]
